...
def covering_fractions_2k(line_list, N_thresh, delta_r):
    ...
    return covering_fraction_various('./absorbers_2Mpc_LG_to_mw_2000/',
...
if __name__=='__main__':
    ...
    _, covfs_9 = covering_fractions_2k(['Si III 1206', 'Si II 1260', \
                                        'C II 1335', 'C IV 1551', 'Si IV 1403'],
                                        1e9, R_BIN_LENGTH)

    print('finally covering fractions > 1e12')
    _, covfs_12 = covering_fractions_2k(['Si III 1206', 'Si II 1260', \
                                        'C II 1335', 'C IV 1551', 'Si IV 1403'],
                                        1e12, R_BIN_LENGTH)
    r /= HUBBLE_2Mpc_LG
